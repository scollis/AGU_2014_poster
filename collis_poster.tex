  ...
  \begin{columns}[t]
        ...
        \begin{columns}[T]
          \begin{column}{.49\linewidth}
            ...
            \item HMMs are used to compensate time and amplitude variations of the signers\par
              \vskip2ex              
              \centerline{\includegraphics[width=.5\linewidth]{ACRF_V_RGB.jpg}}
            \end{itemize}
          \end{column}
          \begin{column}{.49\linewidth}
            \begin{itemize}
            ...
            \end{itemize}
            \vskip2ex
            \includegraphics[width=\linewidth]{ACRF_V_RGB.jpg}
          \end{column}
        \end{columns}
      \end{block}
      ...
      \begin{block}{Experimental Setup}
        \begin{columns}[t]
          ...
          \begin{column}{.25\linewidth}
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            \centering    
            \includegraphics[width=0.7\linewidth]{ACRF_V_RGB.jpg}\\[1ex]
            \includegraphics[width=0.7\linewidth]{ACRF_V_RGB.jpg}\\[1ex]
            \includegraphics[width=0.7\linewidth]{ACRF_V_RGB.jpg}\\[1ex]          
            \includegraphics[width=0.7\linewidth]{ACRF_V_RGB.jpg}\\[1ex]          
          \end{column}
      ...
      \begin{block}{System Overview}
        ...
        \begin{columns}[t]
          ...
          \begin{column}{.5\linewidth}
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            \centering
            \includegraphics[height=0.33\linewidth]{ACRF_V_RGB.jpg}
            \quad\quad
            \includegraphics[height=0.33\linewidth]{ACRF_V_RGB.jpg}
            \vskip3ex
            \includegraphics[height=0.4\linewidth]{ACRF_V_RGB.jpg}
            \quad
            \includegraphics[height=0.4\linewidth]{ACRF_V_RGB.jpg}
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          \end{column}
      ...
      \begin{block}{Feature Selection and Model Combination}
        \begin{columns}[T]
          ...
          \begin{column}{.65\linewidth}
            \raggedleft
            \includegraphics[width=.95\linewidth]{ACRF_V_RGB.jpg}%
          \end{column}
        \end{columns}
    ...
    \begin{column}{.3\linewidth}
      ...
      \begin{block}{Experimental Results}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \centering
        \includegraphics[width=0.33\linewidth]{ACRF_V_RGB.jpg}%
        \includegraphics[width=0.33\linewidth]{ACRF_V_RGB.jpg}%
        \includegraphics[width=0.33\linewidth]{ACRF_V_RGB.jpg}%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
